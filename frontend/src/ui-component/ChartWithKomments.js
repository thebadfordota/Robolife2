...
const ChartWithKomments = ({ chartRootName, data, intervalTimeUnit, intervalCount }) => {
        ...
        function createSeries(name, field) {
            let series = chart.series.push(
                am5xy.LineSeries.new(root, {
                    ...
                    valueYField: field,
                    valueXField: 'date',
                    tooltipHTML: '<strong>{valueX.formatDate()}</strong>: {valueY}',
                    tooltip: am5.Tooltip.new(root, {
            ...
            bulletTemplate.events.on('click', function (ev) {
                ...
                const ModalWindowData = {
                    ...
                    value: ev.target.dataItem.dataContext.solarRadiation
                };

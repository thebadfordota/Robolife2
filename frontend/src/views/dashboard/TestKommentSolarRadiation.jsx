...
import ChartWithKomments from '../../ui-component/ChartWithKomments';
...
const SolarRadiation = () => {
    ...
    return (
        <div>
            <MainCard title="Солнечная радиация" subheader={stationData}>
                <ChartDateRangePicker date={date} setDate={setDate} />
                <DataFrequencyPicker freq={freq} setFreq={setFreq} />
            </MainCard>
            <SubCard title="Солнечная радиация c комментариями">
                <ChartWithKomments chartRootName="chart1" data={data} intervalTimeUnit={DATA_FREQUENCY_CONVERT[freq]} intervalCount={1} />
            </SubCard>
        </div>
    );
};
